...
function LogMoodAndActivities () {
  ...
  const handleSubmit = async (e) => {
    ...
    const activitiesArray = Object.entries(activities).flatMap(([category, options]) => options.map(option => ({category, option})));
  ...
  return (
    ...
    <div className="mood-and-activities-page">
      ...
      <button className="entry-button" onClick={handleSubmit}>Log Mood and Activities</button>
