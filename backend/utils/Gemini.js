...
const systemInstruction = ` You are an AI designed to refine initial journal prompts for users. 
...
- Maintain the names of the moods and activities in the refined prompt. 
...
Example:
- Initial Prompt: "You seem sad today after your swimming session. Do you want to talk about it?"
